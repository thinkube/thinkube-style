---
description: Validate a React component follows migration standards
argument-hint: <react-file-path>
---

# Validate Migration

Check if a React component at `$ARGUMENTS` follows migration standards and quality rules.
