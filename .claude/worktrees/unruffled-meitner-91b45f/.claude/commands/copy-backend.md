---
description: Copy backend Python/FastAPI files unchanged from Vue to React app
argument-hint: <backend-file-path>
---

# Copy Backend Files Unchanged

Backend Python/FastAPI code at `$ARGUMENTS` doesn't need migration - copy as-is to the React app.
