...
description: Convert a Vue component to React + shadcn/ui following Thinkube standards. Maps DaisyUI classes to shadcn/ui components per COMPONENT_MAPPING.md and applies DESIGN_PATTERNS.md criteria.
---

# Migrate Vue Component to React

Given a Vue component file path, convert it to React + shadcn/ui following Thinkube standards.

## Input
- Vue component file path (from thinkube-installer or thinkube-control)

## Process

1. **Read the Vue component** and analyze its structure
...
8. **Write the React component** to the appropriate location
